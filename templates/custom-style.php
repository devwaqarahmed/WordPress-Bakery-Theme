<?php 
/**
 * The Custom Style for SKT Nutristore
 *
...
/*Home Product Colors*/
.newproductgallery ul#portfolioprod li .product-button .view-all-btn a{background:<?php echo $complete['product_cartbtn_bgcolor'] ?>; color:<?php echo $complete['product_cartbtn_color'] ?> !important;}
.newproductgallery ul#portfolioprod li {background-color:<?php echo $complete['product_box_bgcolor'] ?>;}
.newproductgallery ul#portfolioprod li .product-button::after {background-color: rgba(<?php echo complete_hex2rgb($complete['product_box_hover_bgcolor']);?>, 0.8);}
.newproductgallery ul#portfolioprod li a h5 {color:<?php echo $complete['product_title_color'] ?>;}
.newproductgallery .newproprice span.woocommerce-Price-amount {color:<?php echo $complete['product_price_color'] ?>;}

.skt-home-posts-row .skt-home-posts-title a{color: <?php echo $complete['homepost_title_color'] ?>;}
.skt-home-posts-row .skt-home-posts-title a:hover {color: <?php echo $complete['homepost_title_hover_color'] ?>;}
.skt-home-posts-row .skt-home-posts-date{color: <?php echo $complete['homepost_readmore_color'] ?>;}
.skt-home-posts-row .skt-home-posts-readmore{color: <?php echo $complete['homepost_readmore_color'] ?>;}

.skt-anything-content h3, .skt-anything-content h3 small {color: <?php echo $complete['home_couponslider_title_color'] ?>;}
.skt-anything-content p {color: <?php echo $complete['home_couponslider_text_color'] ?>;}
.skt-anything-content a {color: <?php echo $complete['home_couponslider_btn_color'] ?>; background-color: <?php echo $complete['home_couponslider_btn_bgcolor'] ?>;}
.skt-anything-content a:hover {color: <?php echo $complete['home_couponslider_btn_hcolor'] ?>; background-color: <?php echo $complete['home_couponslider_btn_hbgcolor'] ?>;}
.skt-anything-slider .sa_owl_theme .owl-dots .owl-dot span {background-color: <?php echo $complete['home_couponslider_pager_color'] ?> !important;}
.skt-anything-slider .sa_owl_theme .owl-dots .active span {background-color:<?php echo $complete['home_couponslider_active_pager_color'] ?> !important;}

/*-----------------------------COLORS------------------------------------*/
		/*Header Color*/
		.header_wrap, .header{background-color: rgba(<?php echo complete_hex2rgb($complete['head_color_id']);?>, <?php if(empty($complete['head_transparent'])){ echo '1'; }else { echo $complete['head_bg_trans'];} ?>);}
		...
		.nivo-directionNav a{
			color:<?php echo $complete['slide_active_pager_color_id']; ?>
		}
		a.nivo-prevNav:hover, a.nivo-nextNav:hover{
			color:<?php echo $complete['slide_pager_color_id']; ?>;
		}			
		...
		/* Testimonial Colors */
		.skt-testimonial-slider .bxslider li{background-color:<?php echo $complete['testimonialbox_color_id']; ?>;}	
		.skt-testimonial-slider h3 {color:<?php echo $complete['testimonialbox_title_color']; ?>;}
	    .skt-testimonial-slider p {color:<?php echo $complete['testimonialbox_desig_color']; ?>;}
		.skt-testimonial-slider .testimonilacontent{color:<?php echo $complete['testimonialbox_txt_color']; ?>;}
		...
		.header-extras li .custom-cart-count{background-color: <?php echo $complete['mobbgtop_color_id']; ?>;}
		...
		#topmenu ul li ul li a:hover{color:<?php echo $complete['menutxt_color_hover']; ?>;}
