                ...
                <div class="footer-info">
                    ...
                    <div class="col-6">
                        <div class="box footer-social-icons">
							<?php if (!empty ($complete['footer_social_icon'])) { $ft2icon = html_entity_decode($complete['footer_social_icon']); $ft2icon = stripslashes($ft2icon); ?>
